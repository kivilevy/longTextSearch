...
export const handleSearchAndResults = async (text, reqBody) => {
  const pagesArray = [];
...
const insertFootnotes = (overlap, chunk, index, results, matchDetailsArray) => {
  let footnotedChunk = "";
  let currentPos = 0;
...
const storeMatchInfo = (result, footnoteNumber, index, matchDetailsArray) => {
